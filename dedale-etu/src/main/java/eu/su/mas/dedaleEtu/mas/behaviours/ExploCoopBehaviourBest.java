 ...
 *
 */
public class ExploCoopBehaviourBest extends SimpleBehaviour {
 ...
 */
	public ExploCoopBehaviourBest(final AbstractDedaleAgent myagent, MapRepresentation myMap,List<String> agentNames) {
		super(myagent);
		this.myMap=myMap;
